<template>
  <div class="dice-container">
    <div
      ...
      @click="handleClick"
    >
      <div class="dice-type-label">D20</div>
      <div class="dice-face">
        <div class="dice-shape">
          <svg viewBox="0 0 100 100" class="dice-polygon">
            <polygon points="50,10 90,30 90,70 50,90 10,70 10,30" :fill="diceColor" />
          </svg>
...
const startRoll = () => {
  ...
  // Wheel animation - cycle through random numbers
  let count = 0;
  const maxCount = 20; // Number of spins
