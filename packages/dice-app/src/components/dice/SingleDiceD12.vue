<template>
  <div class="dice-container">
    <div
      ...
      @click="handleClick"
    >
      <div class="dice-type-label">D12</div>
      <div class="dice-face">
        <div class="dice-shape">
          <svg viewBox="0 0 100 100" class="dice-polygon">
            <polygon points="50,5 85,20 95,50 85,80 50,95 15,80 5,50 15,20" :fill="diceColor" />
          </svg>
...
const startRoll = () => {
  ...
  const interval = setInterval(() => {
    displayValue.value = Math.floor(Math.random() * 12) + 1;
    count++;
